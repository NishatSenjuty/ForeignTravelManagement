...
function load_TRFApproval_table(page) {
    ...
    $.ajax({
        type: "POST",
        url: "/MDBudgetApproval/ShowTRFApprovalSup",
        contentType: "application/json; charset-utf-8",
...
function load_TRFApproval_Management_table(page) {
    ...
    $.ajax({
        type: "POST",
        url: "/MDBudgetApproval/ShowTRFApprovalMan1",
        contentType: "application/json; charset-utf-8",
        data: JSON.stringify(json),
...
function show_TRFApproval_list(resp) {
    ...
    $.each(resp, function (index, value) {
        ...
        $("<tr>").attr("class", "text-center").append(iconcell, FullName,
            CompanyName, DesignationName, costReq, advReq).appendTo("#ls_EmpInfo_table_tbody");
